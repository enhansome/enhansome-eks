...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-23 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,017 | 🐛 125 | 🌐 Go | 📅 2026-08-31, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,478 | 🐛 96 | 🌐 Go | 📅 2026-08-29 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,967 | 🐛 41 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,090 | 🐛 661 | 🌐 Go | 📅 2026-08-31
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,082 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,271 | 🐛 191 | 🌐 Go | 📅 2026-08-31
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,453 | 🐛 38 | 🌐 Go | 📅 2026-08-31
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,162 | 🐛 97 | 🌐 Go | 📅 2026-08-24
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,065 | 🐛 150 | 🌐 Go | 📅 2026-08-31 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 130 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-31 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,169 | 🐛 562 | 🌐 Go | 📅 2026-08-29

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,781 | 🐛 105 | 🌐 Java | 📅 2026-08-31
...
* [Goldilocks vertical-pod-autoscaler](https://github.com/FairwindsOps/goldilocks/) ⭐ 3,334 | 🐛 14 | 🌐 Go | 📅 2026-08-31
* [Escalator](https://github.com/atlassian/escalator) ⭐ 686 | 🐛 18 | 🌐 Go | 📅 2026-07-06 - A batch or job optimized horizontal autoscaler
* [kube-metrics-adapter](https://github.com/zalando-incubator/kube-metrics-adapter) ⭐ 544 | 🐛 13 | 🌐 Go | 📅 2026-08-31
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,862 | 🐛 548 | 🌐 Go | 📅 2026-08-27
...
* [Rook](https://github.com/rook/rook) ⭐ 13,623 | 🐛 131 | 🌐 Go | 📅 2026-08-31
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,135 | 🐛 28 | 🌐 Go | 📅 2026-08-31
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 804 | 🐛 12 | 🌐 Go | 📅 2026-08-31
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,320 | 🐛 130 | 🌐 Go | 📅 2026-08-28 - AWS ALB Ingress Controller for Kubernetes
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,064 | 🐛 193 | 🌐 Lua | 📅 2026-08-16
...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,843 | 🐛 0 | 📅 2026-08-21 — Machine Learning Toolkit for Kubernetes
...
* [AWS container services roadmap](https://github.com/aws/containers-roadmap/projects/1) ⭐ 5,356 | 🐛 1,589 | 🌐 Shell | 📅 2025-03-25
