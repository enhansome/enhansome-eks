...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-09 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,014 | 🐛 121 | 🌐 Go | 📅 2026-08-15, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,357 | 🐛 111 | 🌐 Go | 📅 2026-08-14 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,940 | 🐛 39 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,039 | 🐛 598 | 🌐 Go | 📅 2026-08-14
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,076 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,265 | 🐛 172 | 🌐 Go | 📅 2026-08-10
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,141 | 🐛 94 | 🌐 Go | 📅 2026-08-10
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,042 | 🐛 143 | 🌐 Go | 📅 2026-08-13 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-15 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,102 | 🐛 564 | 🌐 Go | 📅 2026-08-15
...
* [Rook](https://github.com/rook/rook) ⭐ 13,598 | 🐛 126 | 🌐 Go | 📅 2026-08-14
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,319 | 🐛 129 | 🌐 Go | 📅 2026-08-13 - AWS ALB Ingress Controller for Kubernetes
...
* [Kong](https://github.com/Kong/kong) ⭐ 43,987 | 🐛 189 | 🌐 Lua | 📅 2026-08-04
