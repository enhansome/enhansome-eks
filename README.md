...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-23 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,017 | 🐛 128 | 🌐 Go | 📅 2026-09-01, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,485 | 🐛 91 | 🌐 Go | 📅 2026-09-01 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,969 | 🐛 41 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
* [kube-ps1](https://github.com/jonmosco/kube-ps1) ⭐ 3,808 | 🐛 5 | 🌐 Shell | 📅 2026-05-24 — Kubernetes prompt for bash and zsh.  Adds the current context and namespace to the prompt
...
* [kubectl debug](https://github.com/aylei/kubectl-debug) ⭐ 2,302 | 🐛 62 | 🌐 Go | 📅 2023-10-19 - Debug your pod by a new container with every troubleshooting tools pre-installed
...
* [Amazon EKS Helm chart repository](https://github.com/aws/eks-charts) ⭐ 1,304 | 🐛 223 | 🌐 Mustache | 📅 2026-08-31

## Security

* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,092 | 🐛 664 | 🌐 Go | 📅 2026-09-01
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,082 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,273 | 🐛 192 | 🌐 Go | 📅 2026-09-01
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,453 | 🐛 44 | 🌐 Go | 📅 2026-09-01
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,161 | 🐛 97 | 🌐 Go | 📅 2026-08-24
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,066 | 🐛 150 | 🌐 Go | 📅 2026-09-01 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-01 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,079 | 🐛 15 | 🌐 Go | 📅 2026-08-31
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,170 | 🐛 570 | 🌐 Go | 📅 2026-09-01

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,781 | 🐛 105 | 🌐 Java | 📅 2026-09-01
...
* [Goldilocks vertical-pod-autoscaler](https://github.com/FairwindsOps/goldilocks/) ⭐ 3,338 | 🐛 15 | 🌐 Go | 📅 2026-09-01
* [Escalator](https://github.com/atlassian/escalator) ⭐ 686 | 🐛 18 | 🌐 Go | 📅 2026-07-06 - A batch or job optimized horizontal autoscaler
* [kube-metrics-adapter](https://github.com/zalando-incubator/kube-metrics-adapter) ⭐ 544 | 🐛 14 | 🌐 Go | 📅 2026-09-01
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,865 | 🐛 543 | 🌐 Go | 📅 2026-09-01
* [LitmusChaos](https://github.com/litmuschaos/litmus) ⭐ 5,604 | 🐛 399 | 🌐 Go | 📅 2026-08-25
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,073 | 🐛 25 | 🌐 Go | 📅 2026-08-12
...
* [Rook](https://github.com/rook/rook) ⭐ 13,623 | 🐛 127 | 🌐 Go | 📅 2026-09-01
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,135 | 🐛 26 | 🌐 Go | 📅 2026-09-01
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 804 | 🐛 13 | 🌐 Go | 📅 2026-08-31
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,320 | 🐛 129 | 🌐 Go | 📅 2026-09-01 - AWS ALB Ingress Controller for Kubernetes
* [Contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 121 | 🌐 HTML | 📅 2026-08-31
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,071 | 🐛 193 | 🌐 Lua | 📅 2026-08-16
* [Ambassador](https://github.com/datawire/ambassador) ⭐ 4,520 | 🐛 440 | 🌐 Python | 📅 2026-08-24
...
* [AWS container services roadmap](https://github.com/aws/containers-roadmap/projects/1) ⭐ 5,357 | 🐛 1,589 | 🌐 Shell | 📅 2025-03-25
