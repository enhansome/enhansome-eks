...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 14 | 🌐 Go | 📅 2026-09-02 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,017 | 🐛 134 | 🌐 Go | 📅 2026-09-07, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,534 | 🐛 82 | 🌐 Go | 📅 2026-09-06 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,978 | 🐛 42 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,422 | 🐛 16 | 🌐 Go | 📅 2026-08-31
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,118 | 🐛 687 | 🌐 Go | 📅 2026-09-07
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,072 | 🐛 150 | 🌐 Go | 📅 2026-09-01 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-07 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,082 | 🐛 14 | 🌐 Go | 📅 2026-09-07
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,195 | 🐛 562 | 🌐 Go | 📅 2026-09-07

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,782 | 🐛 103 | 🌐 Java | 📅 2026-09-07
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,880 | 🐛 544 | 🌐 Go | 📅 2026-09-06
* [LitmusChaos](https://github.com/litmuschaos/litmus) ⭐ 5,607 | 🐛 401 | 🌐 Go | 📅 2026-08-25
...
* [Rook](https://github.com/rook/rook) ⭐ 13,645 | 🐛 140 | 🌐 Go | 📅 2026-09-07
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,322 | 🐛 133 | 🌐 Go | 📅 2026-09-01 - AWS ALB Ingress Controller for Kubernetes
* [Contour](https://github.com/projectcontour/contour) ⭐ 3,946 | 🐛 121 | 🌐 HTML | 📅 2026-09-07
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,096 | 🐛 194 | 🌐 Lua | 📅 2026-09-07
