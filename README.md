...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 14 | 🌐 Go | 📅 2026-09-20 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,023 | 🐛 130 | 🌐 Go | 📅 2026-09-21, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,638 | 🐛 79 | 🌐 Go | 📅 2026-09-21 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 20,001 | 🐛 42 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
* [kube-ps1](https://github.com/jonmosco/kube-ps1) ⭐ 3,813 | 🐛 4 | 🌐 Shell | 📅 2026-09-07 — Kubernetes prompt for bash and zsh.  Adds the current context and namespace to the prompt
* [kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,437 | 🐛 16 | 🌐 Go | 📅 2026-08-31
...
* [Amazon EKS Helm chart repository](https://github.com/aws/eks-charts) ⭐ 1,309 | 🐛 225 | 🌐 Mustache | 📅 2026-09-15

## Security

* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,172 | 🐛 753 | 🌐 Go | 📅 2026-09-21
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,086 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,277 | 🐛 195 | 🌐 Go | 📅 2026-09-21
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,457 | 🐛 45 | 🌐 Go | 📅 2026-09-21
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,191 | 🐛 108 | 🌐 Go | 📅 2026-09-21
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,085 | 🐛 148 | 🌐 Go | 📅 2026-09-21 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,083 | 🐛 14 | 🌐 Go | 📅 2026-09-18
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,229 | 🐛 541 | 🌐 Go | 📅 2026-09-21

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,792 | 🐛 104 | 🌐 Java | 📅 2026-09-21
...
* [Goldilocks vertical-pod-autoscaler](https://github.com/FairwindsOps/goldilocks/) ⭐ 3,346 | 🐛 14 | 🌐 Go | 📅 2026-09-18
* [Escalator](https://github.com/atlassian/escalator) ⭐ 687 | 🐛 18 | 🌐 Go | 📅 2026-09-11 - A batch or job optimized horizontal autoscaler
* [kube-metrics-adapter](https://github.com/zalando-incubator/kube-metrics-adapter) ⭐ 542 | 🐛 13 | 🌐 Go | 📅 2026-09-21
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,909 | 🐛 546 | 🌐 Go | 📅 2026-09-10
* [LitmusChaos](https://github.com/litmuschaos/litmus) ⭐ 5,618 | 🐛 389 | 🌐 Go | 📅 2026-09-21
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,080 | 🐛 5 | 🌐 Go | 📅 2026-09-20
...
* [Rook](https://github.com/rook/rook) ⭐ 13,664 | 🐛 145 | 🌐 Go | 📅 2026-09-21
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,134 | 🐛 29 | 🌐 Go | 📅 2026-09-21
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 806 | 🐛 9 | 🌐 Go | 📅 2026-09-21
* [Amazon FSx for Lustre CSI driver](https://github.com/kubernetes-sigs/aws-fsx-csi-driver) ⭐ 144 | 🐛 14 | 🌐 Go | 📅 2026-08-05
* [OpenEBS](https://help.mayadata.io/hc/en-us/articles/360037226451-Creating-an-OpenEBS-cluster-in-an-EKS-cluster)

## Ingress

* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,328 | 🐛 139 | 🌐 Go | 📅 2026-09-17 - AWS ALB Ingress Controller for Kubernetes
* [Contour](https://github.com/projectcontour/contour) ⭐ 3,949 | 🐛 122 | 🌐 HTML | 📅 2026-09-21
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,167 | 🐛 201 | 🌐 Lua | 📅 2026-09-07
* [Ambassador](https://github.com/datawire/ambassador) ⭐ 4,522 | 🐛 403 | 🌐 Python | 📅 2026-09-18
...
* [AWS container services roadmap](https://github.com/aws/containers-roadmap/projects/1) ⭐ 5,361 | 🐛 1,592 | 🌐 Shell | 📅 2025-03-25
