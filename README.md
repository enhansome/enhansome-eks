...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 13 | 🌐 Go | 📅 2026-09-02 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,017 | 🐛 134 | 🌐 Go | 📅 2026-09-04, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,506 | 🐛 85 | 🌐 Go | 📅 2026-09-03 - Provides a terminal UI to interact with your Kubernetes clusters
...
* [kube-ps1](https://github.com/jonmosco/kube-ps1) ⭐ 3,810 | 🐛 5 | 🌐 Shell | 📅 2026-05-24 — Kubernetes prompt for bash and zsh.  Adds the current context and namespace to the prompt
* [kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,420 | 🐛 16 | 🌐 Go | 📅 2026-08-31
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,110 | 🐛 666 | 🌐 Go | 📅 2026-09-04
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,452 | 🐛 45 | 🌐 Go | 📅 2026-09-04
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,171 | 🐛 100 | 🌐 Go | 📅 2026-08-24
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-04 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,082 | 🐛 14 | 🌐 Go | 📅 2026-09-03
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,188 | 🐛 577 | 🌐 Go | 📅 2026-09-03

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,782 | 🐛 103 | 🌐 Java | 📅 2026-09-04
...
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,075 | 🐛 25 | 🌐 Go | 📅 2026-09-04
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,981 | 🐛 55 | 🌐 Python | 📅 2023-11-10
* [chaoskube](https://github.com/linki/chaoskube) ⭐ 1,934 | 🐛 36 | 🌐 Go | 📅 2026-09-01
* [Gremlin](https://www.gremlin.com/community/tutorials/how-to-install-and-use-gremlin-with-eks/)

## Storage

* [Rook](https://github.com/rook/rook) ⭐ 13,636 | 🐛 129 | 🌐 Go | 📅 2026-09-03
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,321 | 🐛 131 | 🌐 Go | 📅 2026-09-01 - AWS ALB Ingress Controller for Kubernetes
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,084 | 🐛 195 | 🌐 Lua | 📅 2026-09-03
* [Ambassador](https://github.com/datawire/ambassador) ⭐ 4,520 | 🐛 441 | 🌐 Python | 📅 2026-09-03
