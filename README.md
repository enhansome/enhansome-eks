...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-16 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,015 | 🐛 124 | 🌐 Go | 📅 2026-08-20, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,397 | 🐛 115 | 🌐 Go | 📅 2026-08-20 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,951 | 🐛 39 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,056 | 🐛 607 | 🌐 Go | 📅 2026-08-20
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,452 | 🐛 31 | 🌐 Go | 📅 2026-08-20
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,056 | 🐛 144 | 🌐 Go | 📅 2026-08-18 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,179 | 🐛 106 | 🌐 Go | 📅 2026-08-20 — Add-on agent to generate and expose cluster-level metrics.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-20 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,122 | 🐛 564 | 🌐 Go | 📅 2026-08-20

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,770 | 🐛 116 | 🌐 Java | 📅 2026-08-20
...
* [Goldilocks vertical-pod-autoscaler](https://github.com/FairwindsOps/goldilocks/) ⭐ 3,317 | 🐛 13 | 🌐 Go | 📅 2026-08-18
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,849 | 🐛 550 | 🌐 Go | 📅 2026-08-18
...
* [Rook](https://github.com/rook/rook) ⭐ 13,604 | 🐛 138 | 🌐 Go | 📅 2026-08-20
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,134 | 🐛 26 | 🌐 Go | 📅 2026-08-19
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 804 | 🐛 15 | 🌐 Go | 📅 2026-08-19
...
* [Contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 122 | 🌐 HTML | 📅 2026-08-18
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,009 | 🐛 189 | 🌐 Lua | 📅 2026-08-16
* [Ambassador](https://github.com/datawire/ambassador) ⭐ 4,518 | 🐛 439 | 🌐 Python | 📅 2026-08-19
