...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 14 | 🌐 Go | 📅 2026-09-11 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,019 | 🐛 131 | 🌐 Go | 📅 2026-09-11, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,566 | 🐛 80 | 🌐 Go | 📅 2026-09-11 - Provides a terminal UI to interact with your Kubernetes clusters
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,137 | 🐛 694 | 🌐 Go | 📅 2026-09-12
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,080 | 🐛 148 | 🌐 Go | 📅 2026-09-09 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 134 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-12 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,203 | 🐛 556 | 🌐 Go | 📅 2026-09-10

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,786 | 🐛 108 | 🌐 Java | 📅 2026-09-12
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,890 | 🐛 544 | 🌐 Go | 📅 2026-09-10
...
* [Rook](https://github.com/rook/rook) ⭐ 13,656 | 🐛 142 | 🌐 Go | 📅 2026-09-11
