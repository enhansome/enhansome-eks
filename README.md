...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-23 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,017 | 🐛 123 | 🌐 Go | 📅 2026-08-25, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,425 | 🐛 102 | 🌐 Go | 📅 2026-08-24 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,956 | 🐛 40 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,068 | 🐛 642 | 🌐 Go | 📅 2026-08-25
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,056 | 🐛 145 | 🌐 Go | 📅 2026-08-18 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-25 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,137 | 🐛 568 | 🌐 Go | 📅 2026-08-24

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,774 | 🐛 103 | 🌐 Java | 📅 2026-08-24
...
* [Rook](https://github.com/rook/rook) ⭐ 13,612 | 🐛 142 | 🌐 Go | 📅 2026-08-24
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,135 | 🐛 28 | 🌐 Go | 📅 2026-08-19
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,033 | 🐛 190 | 🌐 Lua | 📅 2026-08-16
...
* [AWS container services roadmap](https://github.com/aws/containers-roadmap/projects/1) ⭐ 5,356 | 🐛 1,599 | 🌐 Shell | 📅 2025-03-25
