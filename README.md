...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 13 | 🌐 Go | 📅 2026-09-20 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,023 | 🐛 130 | 🌐 Go | 📅 2026-09-20, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,633 | 🐛 78 | 🌐 Go | 📅 2026-09-18 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,994 | 🐛 42 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,436 | 🐛 16 | 🌐 Go | 📅 2026-08-31
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,170 | 🐛 746 | 🌐 Go | 📅 2026-09-20
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,190 | 🐛 107 | 🌐 Go | 📅 2026-09-07
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,226 | 🐛 548 | 🌐 Go | 📅 2026-09-20
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,908 | 🐛 546 | 🌐 Go | 📅 2026-09-10
* [LitmusChaos](https://github.com/litmuschaos/litmus) ⭐ 5,618 | 🐛 392 | 🌐 Go | 📅 2026-09-20
...
* [Rook](https://github.com/rook/rook) ⭐ 13,663 | 🐛 140 | 🌐 Go | 📅 2026-09-18
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,327 | 🐛 139 | 🌐 Go | 📅 2026-09-17 - AWS ALB Ingress Controller for Kubernetes
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,161 | 🐛 200 | 🌐 Lua | 📅 2026-09-07
