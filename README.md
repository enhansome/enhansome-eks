...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 185 | 🐛 13 | 🌐 Go | 📅 2026-09-21 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,023 | 🐛 129 | 🌐 Go | 📅 2026-09-24, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,671 | 🐛 80 | 🌐 Go | 📅 2026-09-24 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 20,013 | 🐛 40 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
* [kube-ps1](https://github.com/jonmosco/kube-ps1) ⭐ 3,812 | 🐛 5 | 🌐 Shell | 📅 2026-09-23 — Kubernetes prompt for bash and zsh.  Adds the current context and namespace to the prompt
* [kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,438 | 🐛 16 | 🌐 Go | 📅 2026-08-31
...
* [Amazon EKS Helm chart repository](https://github.com/aws/eks-charts) ⭐ 1,309 | 🐛 226 | 🌐 Mustache | 📅 2026-09-15

## Security

* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,178 | 🐛 780 | 🌐 Go | 📅 2026-09-24
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,457 | 🐛 47 | 🌐 Go | 📅 2026-09-24
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,197 | 🐛 108 | 🌐 Go | 📅 2026-09-22
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,085 | 🐛 145 | 🌐 Go | 📅 2026-09-24 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,210 | 🐛 112 | 🌐 Go | 📅 2026-09-24 — Add-on agent to generate and expose cluster-level metrics.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,083 | 🐛 14 | 🌐 Go | 📅 2026-09-24
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,238 | 🐛 536 | 🌐 Go | 📅 2026-09-24

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,794 | 🐛 107 | 🌐 Java | 📅 2026-09-24
...
* [Goldilocks vertical-pod-autoscaler](https://github.com/FairwindsOps/goldilocks/) ⭐ 3,350 | 🐛 16 | 🌐 Go | 📅 2026-09-18
* [Escalator](https://github.com/atlassian/escalator) ⭐ 688 | 🐛 18 | 🌐 Go | 📅 2026-09-11 - A batch or job optimized horizontal autoscaler
* [kube-metrics-adapter](https://github.com/zalando-incubator/kube-metrics-adapter) ⭐ 542 | 🐛 12 | 🌐 Go | 📅 2026-09-22
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,916 | 🐛 546 | 🌐 Go | 📅 2026-09-10
* [LitmusChaos](https://github.com/litmuschaos/litmus) ⭐ 5,622 | 🐛 393 | 🌐 Go | 📅 2026-09-22
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,081 | 🐛 5 | 🌐 Go | 📅 2026-09-20
...
* [Rook](https://github.com/rook/rook) ⭐ 13,667 | 🐛 142 | 🌐 Go | 📅 2026-09-24
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,135 | 🐛 28 | 🌐 Go | 📅 2026-09-24
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 806 | 🐛 12 | 🌐 Go | 📅 2026-09-23
* [Amazon FSx for Lustre CSI driver](https://github.com/kubernetes-sigs/aws-fsx-csi-driver) ⭐ 144 | 🐛 13 | 🌐 Go | 📅 2026-09-22
* [OpenEBS](https://help.mayadata.io/hc/en-us/articles/360037226451-Creating-an-OpenEBS-cluster-in-an-EKS-cluster)

## Ingress

* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,331 | 🐛 139 | 🌐 Go | 📅 2026-09-23 - AWS ALB Ingress Controller for Kubernetes
* [Contour](https://github.com/projectcontour/contour) ⭐ 3,952 | 🐛 122 | 🌐 HTML | 📅 2026-09-21
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,189 | 🐛 209 | 🌐 Lua | 📅 2026-09-24
* [Ambassador](https://github.com/datawire/ambassador) ⭐ 4,523 | 🐛 402 | 🌐 Python | 📅 2026-09-22
...
* [AWS container services roadmap](https://github.com/aws/containers-roadmap/projects/1) ⭐ 5,362 | 🐛 1,592 | 🌐 Shell | 📅 2025-03-25
