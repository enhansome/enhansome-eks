...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-16 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,014 | 🐛 121 | 🌐 Go | 📅 2026-08-16, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,370 | 🐛 111 | 🌐 Go | 📅 2026-08-14 - Provides a terminal UI to interact with your Kubernetes clusters
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,043 | 🐛 593 | 🌐 Go | 📅 2026-08-14
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,076 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,265 | 🐛 176 | 🌐 Go | 📅 2026-08-10
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) ⭐ 2,451 | 🐛 31 | 🌐 Go | 📅 2026-08-13
...
* [kube-bench](https://github.com/aquasecurity/kube-bench#running-in-an-eks-cluster) ⭐ 8,142 | 🐛 94 | 🌐 Go | 📅 2026-08-10
...
* [Mizu](https://github.com/up9inc/mizu) ⭐ 12,044 | 🐛 143 | 🌐 Go | 📅 2026-08-13 - The API Traffic Viewer for Kubernetes (Think TCPDump and Wireshark re-invented for Kubernetes)
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,174 | 🐛 102 | 🌐 Go | 📅 2026-08-16 — Add-on agent to generate and expose cluster-level metrics.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-16 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,104 | 🐛 567 | 🌐 Go | 📅 2026-08-16

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,764 | 🐛 126 | 🌐 Java | 📅 2026-08-14
...
* [Chaos Mesh](https://github.com/pingcap/chaos-mesh) ⭐ 7,843 | 🐛 543 | 🌐 Go | 📅 2026-08-07
...
* [Rook](https://github.com/rook/rook) ⭐ 13,599 | 🐛 128 | 🌐 Go | 📅 2026-08-14
* [Amazon EBS CSI driver](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) ⭐ 1,134 | 🐛 27 | 🌐 Go | 📅 2026-08-05
* [Amazon EFS CSI driver](https://github.com/kubernetes-sigs/aws-efs-csi-driver) ⭐ 804 | 🐛 14 | 🌐 Go | 📅 2026-08-03
...
* [ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) ⭐ 4,320 | 🐛 130 | 🌐 Go | 📅 2026-08-13 - AWS ALB Ingress Controller for Kubernetes
...
* [Kong](https://github.com/Kong/kong) ⭐ 43,987 | 🐛 187 | 🌐 Lua | 📅 2026-08-16
...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,814 | 🐛 0 | 📅 2026-07-10 — Machine Learning Toolkit for Kubernetes
