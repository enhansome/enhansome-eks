...
* [aws-k8s-tester](https://github.com/aws/aws-k8s-tester) ⭐ 184 | 🐛 11 | 🌐 Go | 📅 2026-08-16 - Implements [`k8s.io/test-infra/kubetest2`](https://github.com/kubernetes/test-infra/tree/master/kubetest2) ⭐ 4,015 | 🐛 124 | 🌐 Go | 📅 2026-08-22, creates/deletes testing EKS cluster with various add-ons.
...
* [k9s](https://github.com/derailed/k9s) ⭐ 34,410 | 🐛 111 | 🌐 Go | 📅 2026-08-21 - Provides a terminal UI to interact with your Kubernetes clusters
* [kubectx](https://github.com/ahmetb/kubectx) ⭐ 19,953 | 🐛 39 | 🌐 Go | 📅 2026-08-02 — Faster way to switch between clusters and namespaces in kubectl
...
* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,058 | 🐛 618 | 🌐 Go | 📅 2026-08-21
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-22 — Multi-cluster Kubernetes dashboard with real-time observability, AI-powered operations, and CNCF project integrations across EKS and other clusters
...
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,129 | 🐛 568 | 🌐 Go | 📅 2026-08-20

## CI and CD tools

* [Spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,771 | 🐛 105 | 🌐 Java | 📅 2026-08-22
...
* [Rook](https://github.com/rook/rook) ⭐ 13,607 | 🐛 145 | 🌐 Go | 📅 2026-08-21
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,020 | 🐛 190 | 🌐 Lua | 📅 2026-08-16
